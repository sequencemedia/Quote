...
(function bookmarklet() {
  function execute() {
      ...
      quote: {
        travel: {
          annual: {
            step3: {
              applyCampaignCode = () => {
                throw new Error('Default `quote.travel.annual.step3.applyCampaignCode`.');
              }
            } = {}
          } = {}
        } = {}
    ...
    try {
      applyCampaignCode();
    } catch ({ message = 'An error occurred executing `quote.travel.annual.step3.applyCampaignCode`.' }) {
